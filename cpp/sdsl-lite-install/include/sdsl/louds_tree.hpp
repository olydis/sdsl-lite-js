...
public:
	...
	louds_node(size_type f_nr = 0, size_type f_pos = 0)
		: m_nr(f_nr), m_pos(f_pos), nr(m_nr), pos(m_pos)
	{
	}
...
public:
	...
	louds_tree(const Cst& cst, const CstBfsIterator begin, const CstBfsIterator end)
		: m_bv(), m_bv_select1(), m_bv_select0(), bv(m_bv)
	{
	...
	louds_tree(const louds_tree& lt)
		: m_bv(lt.m_bv), m_bv_select1(lt.m_bv_select1), m_bv_select0(lt.m_bv_select0), bv(m_bv)
	{
