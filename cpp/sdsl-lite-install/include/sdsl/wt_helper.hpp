...
struct _node {
	...
	node_type child[2]	= {t_tree_strat_fat::undef,
						  t_tree_strat_fat::undef}; // pointer to the children
...
inline int_vector<>::size_type size(const range_type& r) { return std::get<1>(r) - std::get<0>(r) + 1; }
